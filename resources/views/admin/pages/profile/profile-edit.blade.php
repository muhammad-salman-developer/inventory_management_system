...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="{{ route('admin.profile.updateImage') }}" enctype="multipart/form-data" class="mt-4 text-center">
            @csrf
            ...
            <p class="text-xs text-gray-400 mt-2">Photo change karne ke liye camera icon pe click karein.</p>
        </form>
